...
public class UserController {
   ...
   public String changePasswordPost(@Valid ChangePasswordForm form, BindingResult bindingResult, Model model, Principal principal, final RedirectAttributes redirectAttributes){
      logger.debug("changePasswordPost({})", principal.getName());
      
      final Person person = authenticationFacade.getPerson();
      final boolean currentPasswordMatches = personService.isCurrentPassword(person, form.getCurrentPassword());
      ...
      personService.setPassword(person, form.getNewPassword());
