...
<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#" title="${display_version}">Roster.Guru</a>
		</div>
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">

				<sec:authorize url="/user">
					<li class="list-group-item-info"><a href="<c:url value="/user"/>">Exit Admin</a></li>
				</sec:authorize>

				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><sec:authentication property="principal.person.nameFirst" /> <span class="caret"></span></a>
	...
	<div class="row">
		<div id="navsidebar" class="col-sm-3 col-md-2 sidebar">
			<ul class="nav nav-sidebar">
				...
				<li id="navMessages"><a href="<c:url value="/admin/messages/"/>">Messages</a></li>
			</ul>
			<ul class="nav nav-sidebar">
